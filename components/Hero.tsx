        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-tight mb-6 tracking-tight">
              Transforme conhecimento em <span className="text-brand-600">lucro real.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-10">
              <button 
                ...
                className="w-full sm:w-auto px-8 py-4 bg-brand-600 hover:bg-brand-700 text-white rounded-full font-bold text-lg shadow-lg shadow-brand-200 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2"
              >
                Começar Agora Grátis
                <ArrowRight size={20} />
              </button>
              <a href="#como-funciona" className="w-full sm:w-auto px-8 py-4 bg-white text-slate-700 border border-slate-200 hover:border-brand-300 hover:text-brand-600 rounded-full font-bold text-lg transition-all flex items-center justify-center shadow-sm hover:shadow-md">
                Ver demonstração
              </a>
            </div>
          ...
          <div className="lg:w-1/2 w-full perspective-1000">
            <div className="relative w-full max-w-lg mx-auto bg-white rounded-2xl shadow-2xl border border-slate-100 p-6 transform rotate-y-6 rotate-x-6 hover:rotate-0 transition-all duration-700 ease-out">
              ...
              <div className="flex items-center justify-between mb-6 border-b border-slate-50 pb-4">
                ...
                <div className="text-xs font-semibold text-slate-400 tracking-widest uppercase">PayEasy Dashboard</div>
              </div>

              {/* Stats Grid */}
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-brand-50 p-4 rounded-xl border border-brand-100 group hover:border-brand-200 transition-colors">
                  ...
                  <div className="text-xs text-brand-600 font-medium bg-brand-100 px-2 py-0.5 rounded-full w-fit mt-1">+15% vs ontem</div>
                </div>
              ...
              <div className="space-y-3">
                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-3 hover:bg-slate-50 rounded-xl transition-colors border border-transparent hover:border-slate-100 cursor-default">
              ...
              <div className="absolute -right-8 top-20 bg-white p-4 rounded-xl shadow-xl border border-slate-100 animate-bounce-slow max-w-[220px]">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500 leading-tight mt-1">Você recebeu <span className="font-bold text-green-600">1.200 MT</span> via M-Pesa.</div>
                  </div>
                </div>
              </div>
